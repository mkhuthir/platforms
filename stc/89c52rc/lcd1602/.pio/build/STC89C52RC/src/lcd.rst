                                     ...
                                     10 ;--------------------------------------------------------
                                     11 	.globl _main
                                     12 	.globl _lcd_show_bin_num
                                     13 	.globl _lcd_show_hex_num
                                     14 	.globl _lcd_show_dec_num
                                     15 	.globl _lcd_show_int_num
                                     16 	.globl _lcd_show_string
                                     17 	.globl _lcd_show_char
                                     18 	.globl _lcd_1602_init
                                     19 	.globl _TF2
                                     20 	.globl _EXF2
                                     21 	.globl _RCLK
                                     22 	.globl _TCLK
      ...
      000062                        365 _main:
                           ...
                           000001   372 	ar1 = 0x01
                           000000   373 	ar0 = 0x00
                                    374 ;	src/lcd.c:6: lcd_1602_init();
      000062 12 01 55         [24]  375 	lcall	_lcd_1602_init
                                    376 ;	src/lcd.c:8: lcd_show_char(1, 1, 'A');
      000065 75 0C 01         [24]  377 	mov	_lcd_show_char_PARM_2,#0x01
      000068 75 0D 00         [24]  378 	mov	(_lcd_show_char_PARM_2 + 1),#0x00
      00006B 75 0E 41         [24]  379 	mov	_lcd_show_char_PARM_3,#0x41
      00006E 90 00 01         [24]  380 	mov	dptr,#0x0001
      000071 12 01 90         [24]  381 	lcall	_lcd_show_char
                                    382 ;	src/lcd.c:9: lcd_show_bin_num(1, 3, 0xA5, 8);
      000074 75 25 03         [24]  383 	mov	_lcd_show_bin_num_PARM_2,#0x03
      000077 75 26 00         [24]  384 	mov	(_lcd_show_bin_num_PARM_2 + 1),#0x00
      00007A 75 27 A5         [24]  385 	mov	_lcd_show_bin_num_PARM_3,#0xa5
      00007D 75 28 00         [24]  386 	mov	(_lcd_show_bin_num_PARM_3 + 1),#0x00
      000080 75 29 08         [24]  387 	mov	_lcd_show_bin_num_PARM_4,#0x08
      000083 75 2A 00         [24]  388 	mov	(_lcd_show_bin_num_PARM_4 + 1),#0x00
      000086 90 00 01         [24]  389 	mov	dptr,#0x0001
      000089 12 03 3F         [24]  390 	lcall	_lcd_show_bin_num
                                    391 ;	src/lcd.c:10: lcd_show_string(1, 1, "Hello World!");
      00008C 75 11 41         [24]  392 	mov	_lcd_show_string_PARM_3,#___str_0
      00008F 75 12 04         [24]  393 	mov	(_lcd_show_string_PARM_3 + 1),#(___str_0 >> 8)
      000092 75 13 80         [24]  394 	mov	(_lcd_show_string_PARM_3 + 2),#0x80
      000095 75 0F 01         [24]  395 	mov	_lcd_show_string_PARM_2,#0x01
      000098 75 10 00         [24]  396 	mov	(_lcd_show_string_PARM_2 + 1),#0x00
      00009B 90 00 01         [24]  397 	mov	dptr,#0x0001
      00009E 12 01 9F         [24]  398 	lcall	_lcd_show_string
                                    399 ;	src/lcd.c:11: lcd_show_int_num(2, 1, 457, 3);
      0000A1 75 14 01         [24]  400 	mov	_lcd_show_int_num_PARM_2,#0x01
      0000A4 75 15 00         [24]  401 	mov	(_lcd_show_int_num_PARM_2 + 1),#0x00
      0000A7 75 16 C9         [24]  402 	mov	_lcd_show_int_num_PARM_3,#0xc9
      0000AA 75 17 01         [24]  403 	mov	(_lcd_show_int_num_PARM_3 + 1),#0x01
      0000AD 75 18 03         [24]  404 	mov	_lcd_show_int_num_PARM_4,#0x03
      0000B0 75 19 00         [24]  405 	mov	(_lcd_show_int_num_PARM_4 + 1),#0x00
      0000B3 90 00 02         [24]  406 	mov	dptr,#0x0002
      0000B6 12 01 D7         [24]  407 	lcall	_lcd_show_int_num
                                    408 ;	src/lcd.c:12: lcd_show_dec_num(2, 5, -789, 3);
      0000B9 75 1A 05         [24]  409 	mov	_lcd_show_dec_num_PARM_2,#0x05
      0000BC 75 1B 00         [24]  410 	mov	(_lcd_show_dec_num_PARM_2 + 1),#0x00
      0000BF 75 1C EB         [24]  411 	mov	_lcd_show_dec_num_PARM_3,#0xeb
      0000C2 75 1D FC         [24]  412 	mov	(_lcd_show_dec_num_PARM_3 + 1),#0xfc
      0000C5 75 1E 03         [24]  413 	mov	_lcd_show_dec_num_PARM_4,#0x03
      0000C8 75 1F 00         [24]  414 	mov	(_lcd_show_dec_num_PARM_4 + 1),#0x00
      0000CB 90 00 02         [24]  415 	mov	dptr,#0x0002
      0000CE 12 02 2B         [24]  416 	lcall	_lcd_show_dec_num
                                    417 ;	src/lcd.c:13: lcd_show_hex_num(2, 10, 0xA4, 2);
      0000D1 75 20 0A         [24]  418 	mov	_lcd_show_hex_num_PARM_2,#0x0a
      0000D4 75 21 00         [24]  419 	mov	(_lcd_show_hex_num_PARM_2 + 1),#0x00
      0000D7 75 22 A4         [24]  420 	mov	_lcd_show_hex_num_PARM_3,#0xa4
      0000DA 75 23 02         [24]  421 	mov	_lcd_show_hex_num_PARM_4,#0x02
      0000DD 75 24 00         [24]  422 	mov	(_lcd_show_hex_num_PARM_4 + 1),#0x00
      0000E0 90 00 02         [24]  423 	mov	dptr,#0x0002
      0000E3 12 02 C6         [24]  424 	lcall	_lcd_show_hex_num
                                    425 ;	src/lcd.c:15: while (1) {}
      0000E6                        426 00102$:
                                    427 ;	src/lcd.c:16: }
      0000E6 80 FE            [24]  428 	sjmp	00102$
                                    429 	.area CSEG    (CODE)
                                    430 	.area CONST   (CODE)
                                    431 	.area CONST   (CODE)
      000441                        432 ___str_0:
      000441 48 65 6C 6C 6F 20 57   433 	.ascii "Hello World!"
             6F 72 6C 64 21
      00044D 00                     434 	.db 0x00
                                    435 	.area CSEG    (CODE)
                                    436 	.area XINIT   (CODE)
