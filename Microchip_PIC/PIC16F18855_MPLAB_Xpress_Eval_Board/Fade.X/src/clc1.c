...
void CLC1_Initialize(void)
{
    ...
    CLC1SEL0 = 0x18;    // LC1D1S PWM6_OUT; 
    CLC1SEL1 = 0x19;    // LC1D2S PWM7_OUT; 
    ...
    CLC1GLS1 = 0x08;    // LC1G2D2N disabled; LC1G2D1N disabled; LC1G2D4N disabled; LC1G2D3N disabled; LC1G2D2T enabled; LC1G2D1T disabled; LC1G2D4T disabled; LC1G2D3T disabled; 
    CLC1GLS2 = 0x00;    // LC1G3D1N disabled; LC1G3D2N disabled; LC1G3D3N disabled; LC1G3D4N disabled; LC1G3D1T disabled; LC1G3D2T disabled; LC1G3D3T disabled; LC1G3D4T disabled; 
    ...
    CLC1CON = 0x80;     // LC1EN enabled; INTN disabled; INTP disabled; MODE AND-OR; 
}
